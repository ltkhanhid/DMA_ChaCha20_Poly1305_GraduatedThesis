module ID_EX_reg(
    ...
    input logic i_bp_prediction,     // Branch prediction from ID
    ...
    output logic o_bp_prediction,    // Pass prediction to EX
    ...
    always_ff @(posedge i_clk or negedge i_reset) begin
        if(!i_reset) begin
            ...
            o_bp_prediction <= i_bp_prediction;
            o_br_un <= i_br_un;
            o_funct3 <= i_funct3;
        end
    end
